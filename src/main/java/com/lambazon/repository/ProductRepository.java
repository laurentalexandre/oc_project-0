...
public class ProductRepository {
	...
	private static void generateProductData() {
		...
		products.put(++id, new Product(id, 3, 4.50,"Camenbert", "Fromage de Normandie - France"));
		products.put(++id, new Product(id, 5, 11.75, "Saint Ammour", "Vin du beaujolais - France"));
	}
